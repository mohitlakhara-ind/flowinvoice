...
const replacements = [
  ...
  // Purple -> Primary (We had some hardcoded purples in AI Tools)
  { regex: /bg-purple-500\/15/g, replacement: 'bg-[var(--primary)]\/15' },
  { regex: /bg-purple-500\/20/g, replacement: 'bg-[var(--primary)]\/20' },
  { regex: /text-purple-300/g, replacement: 'text-[var(--primary-light)]' },
  { regex: /text-purple-400/g, replacement: 'text-[var(--primary)]' },
  { regex: /border-purple-500\/30/g, replacement: 'border-[var(--primary)]\/30' },
  { regex: /border-purple-500\/50/g, replacement: 'border-[var(--primary)]\/50' },
];
